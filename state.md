...
5. **Риск GitHub Pages без Pro/Team** (публичность) — найден при аудите 2026-08-04, пока не решён (см. заметку выше). Риск fan-translation PDF решён — оставлены как есть, см. `docs/legal.md`
