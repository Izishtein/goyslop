...
Отсюда же следует, что грамуары идут по рангам B/A/S/SS. На вики предметных данных грамуаров нет: просмотрены все 38 страниц раздела предметов, слова Grimoire нет ни на одной, хотя `items:class-specific` перечисляет фокусы всех остальных школ — Abyssal Knife, Imp Seal, Alchemy Kit, Material Card, Staff of the Sacred Tree.

**Данные грамуаров как предметов нашлись 2026-09-08** — не на вики, а в **Age of Grimoire (SW 2.0)**, pp. 37–38, из второй коллекции владельца (`E:\НРИ\Sword World Rus`, книга есть только в русской папке машинных переводов, но переведена машиной на английский). Это тот же класс-предшественник, что дал грамуарные боевые черты, и с той же оговоркой: механика класса подтверждена совпадением уровень в уровень, а сами предметы 2.5-книга могла изменить. Девять грамуаров (1×B, 3×A, 3×S, 2×SS) заведены в `src/data/equipment.ts` под категорией `classItem`, с `sourceBook: 'Age of Grimoire (SW 2.0)'`. У таблицы общего снаряжения в справочнике нет колонки «Книга» вообще (весь остальной ряд — Core III, ей никогда не требовалось), поэтому оговорка о версии продублирована в начале поля `notes` каждой записи — так она видна на экране, а не только в коде.
