...
**Каталог в приложении не заведён** — это решение владельца проекта (см. `docs/roadmap.md`, § 4). Пока школа остаётся единственной, где на листе работает только ручной ввод.
