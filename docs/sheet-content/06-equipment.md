...
**Core Rulebook III дописывает к этим спискам свои строки** — оружие, броню, щиты, общее
снаряжение и аксессуары, в основном ранга SS, плюс два новых способа улучшения
(Ignidite и Extra Manatite). Построчно всё это — в `15-items-core3.md`; поля и формулы
ниже к ним применяются без изменений.
